...
- 📊 I'm passionate about **Data Science** and **Data Analytics**, turning raw data into actionable insights.
- 🔍 Currently exploring **Machine Learning** and **Deep Learning** applications in healthcare and finance.
- 🛠️ Skilled in **Python, SQL, Excel, Power BI, and Tableau** for end-to-end data analysis and visualization.
- 📍 Based in **Bihar, India**.
- 💼 **Open to Opportunities** — feel free to connect if you're looking for a data professional!
